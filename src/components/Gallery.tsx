...
export default function Gallery() {
  return (
    <section id="consultorio" className="bg-cream pt-20 pb-10 lg:pt-28 lg:pb-14">
      <div className="mx-auto max-w-3xl px-6 text-center lg:px-8">
        <Reveal>
          <p className="mb-3 text-sm font-semibold tracking-[0.2em] text-tan-dark uppercase">
            {galleryContent.eyebrow}
          </p>
          <h2 className="mb-5 font-serif text-3xl text-burgundy sm:text-4xl">
            {galleryContent.heading}
          </h2>
          <p className="text-[#6b5850]">{galleryContent.subtext}</p>
        </Reveal>
      </div>
